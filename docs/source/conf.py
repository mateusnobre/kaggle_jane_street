...
# kaggle_jane_street documentation build
...
from kaggle_jane_street import __version__ as release

# -- Project information -----------------------------------------------------

project = "kaggle_jane_street"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kaggle_jane_streetdoc"
...
latex_documents = [
    (
        master_doc,
        "kaggle_jane_street.tex",
        "kaggle_jane_street Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kaggle_jane_street",
        "Project kaggle_jane_street codebase.",
        "Data-Science",
    )
]
